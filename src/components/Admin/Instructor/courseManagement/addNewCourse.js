...
// import { AddNewCourseInstructor } from "../../../../constants/routePaths";
...
const AddNewCourseInstructor = props => {
...
export default withRouter(connect(mapStateToProps,mapDispatchToProps)(AddNewCourseInstructor))
