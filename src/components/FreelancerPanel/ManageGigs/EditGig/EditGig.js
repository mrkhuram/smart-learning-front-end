...
const EditService = props => {
  ...
  useEffect(() => {
    ...
    if (gig) {
      ...
      setState(gig)
      // gig ? item._id === gig.service_id ? true : false :false
      if (services.services) {

        let serviceCategory = services.services.filter(item => {
          return item._id === gig.service_id
        })
        console.log(serviceCategory[0].english_categories);
        setServiceCate(serviceCategory[0].english_categories)
      }
